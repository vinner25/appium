CREATE DATABASE  IF NOT EXISTS `cleansmiles` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `cleansmiles`;
...
CREATE TABLE `regiondata` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `regionname` (`regionname`,`streetname`,`pincode`),
  KEY `cityid` (`cityid`),
  CONSTRAINT `regiondata_ibfk_1` FOREIGN KEY (`cityid`) REFERENCES `city` (`id`)
...
CREATE TABLE `vendordata` (
  ...
  `pickcount` int(11) NOT NULL,
  `pickavail` tinyint(1) NOT NULL,
...
-- Dump completed on 2017-02-20 23:27:41
